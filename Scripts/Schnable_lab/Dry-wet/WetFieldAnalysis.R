...
#### Preprocess #############
###### Read file
phenoRep1DS = read.csv("Irrigated_Field/irri_rep1_height_est.csv")
phenoRep2DS = read.csv("Irrigated_Field/irri_rep2_height_est.csv")
...
write.csv(phenoRep1DS[,-c(1)], "Irrigated_Field/irri_rep1_height_est_dt.csv")
write.csv(phenoRep2DS[,-c(1)], "Irrigated_Field/irri_rep2_height_est_dt.csv")

#### Don't run the above part again #############
#### Only run the following parts #############
#### preprocess Start from here #############

phenoRep1DS = read.csv("Irrigated_Field/irri_rep1_height_est_dt.csv")
phenoRep2DS = read.csv("Irrigated_Field/irri_rep2_height_est_dt.csv")

genDS = read.csv("Genotype.csv")
genDS$Irrigated = ifelse(genDS$Field=="Irrigated", yes=TRUE, no=FALSE)
genDS = as.data.frame(genDS%>%filter(Irrigated==TRUE))
...
# Save data
write.csv(rep1PhenoDS, "Irrigated_Field/irri_rep1_height_est_new.csv")
write.csv(rep2PhenoDS, "Irrigated_Field/irri_rep2_height_est_new.csv")
...
phenoRep1DS = read.csv("Irrigated_Field/irri_rep1_height_est_new.csv")
phenoRep2DS = read.csv("Irrigated_Field/irri_rep2_height_est_new.csv")
...
write.csv(phenoRep1DS%>%arrange(Genotype, DAP), "Irrigated_Field/irri_data_genotype_rep1.csv")
write.csv(phenoRep2DS%>%arrange(Genotype, DAP), "Irrigated_Field/irri_data_genotype_rep2.csv")
write.csv(grData%>%arrange(Genotype, Replica, DAP), "Irrigated_Field/irri_data_genotype.csv")
